...
def main():
    ...
    savings_interest = float(input("Enter savings interest: "))
    savings_maturity = int(input("Enter the number of months until maturity: "))
    ...
    print(f"The new account balance is ${updated_savings_balance:,.2f}")

    # Prompt the user to set the CD balance, interest rate, and months for the CD account.
    cd_balance = float(input("Enter CD balance: "))
    cd_interest = float(input("Enter CD interest: "))
    cd_maturity = int(input("Enter the number of months until CD maturity: "))
